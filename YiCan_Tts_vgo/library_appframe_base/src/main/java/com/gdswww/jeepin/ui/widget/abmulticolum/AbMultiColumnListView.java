 ...
 */
package com.gdswww.jeepin.ui.widget.abmulticolum;
 ...
 */
public class AbMultiColumnListView extends PullToRefreshScrollView {
	 ...
	 *            the def style
	 */
	private LinearLayout parentLayout, headerLayout;
	...
	public AbMultiColumnListView(Context context, AttributeSet attrs,
		...
		parentLayout.addView(headerLayout, new LinearLayout.LayoutParams(
				LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
		parentLayout.addView(scrollLayout, new LinearLayout.LayoutParams(
				LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
		this.addView(parentLayout, new LinearLayout.LayoutParams(
				LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
	...
	public boolean checkVisibility(int position) {
		...
		int headviewY = 0;
		//如果有头部view，加上头部view的y坐标
		if(headerLayout.getChildAt(0)!=null){
			View v = headerLayout.getChildAt(0);
			int[] location = new int[2];
		    v.getLocationOnScreen(location);
		    headviewY = location[1];
		}
		if (borderBottom > (getScrollY()+headviewY)
