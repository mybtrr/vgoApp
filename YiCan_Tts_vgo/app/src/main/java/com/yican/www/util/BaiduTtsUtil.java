...
public class BaiduTtsUtil {
    ...
    private static BaiduTtsUtil instance = null;

    public static synchronized BaiduTtsUtil getInstance() {
        if (instance == null) {
     ...
     */
    private String appId = "15623655";

    private String appKey = "gF2HcpHDqYH64UVcweUlpuXu";

    private String secretKey = "1j3qWQ2203kGS7f0YvOhGLrBxGhGSclP";
...
//        });
    ...
    public void speak(String speakContent) {
        ...
        int result = mSpeechSynthesizer.speak(speakContent);
        print("合成并播放 按钮已经点击");
