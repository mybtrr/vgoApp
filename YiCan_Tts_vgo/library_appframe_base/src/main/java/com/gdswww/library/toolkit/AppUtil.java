...
public class AppUtil {
	...
	public static boolean appIsRun(Context context, String apkPackageName) {
		...
		for (RunningTaskInfo info : list) {
			if (info.topActivity.getPackageName().equals(apkPackageName)
	...
	public static AppInfo getPackageInfo(Context context, String packageName) {
		...
		if (packageInfo != null) {
			packages.setAppName(packageInfo.applicationInfo.loadLabel(
			...
			packages.setAppIcon(packageInfo.applicationInfo.loadIcon(context
					.getPackageManager()));
		} else {
			packages = null;
		}
