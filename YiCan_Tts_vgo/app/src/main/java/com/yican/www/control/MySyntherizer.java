...
public class MySyntherizer implements com.yican.www.activity.MainHandlerConstant {
    ...
    public MySyntherizer(Context context,  com.yican.www.control.InitConfig initConfig, Handler mainHandler) {
     ...
     * @return 是否初始化成功
     */
    protected boolean init(com.yican.www.control.InitConfig config) {
