...
import com.yican.www.activity.HomeActivity;
import com.yican.www.activity.MachineStoppageActivity;
import com.yican.www.activity.MainActivity;
import com.yican.www.bean.AdvertisementBean;
import com.yican.www.mvp.model.AdvertisementRequestBean;
import com.yican.www.mvp.presenter.AdvertisementPresenter;
import com.yican.www.mvp.view.AdvertisementView;
import com.yican.www.util.BaiduTtsUtil;
import com.yican.www.util.LoadBanner;
...
import static com.yican.www.R.id.btn_openSetting;
...
public abstract class BaseActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BaiduTtsUtil.getInstance().initTTs(this);
    ...
    public static class AdvertisementActivity extends BaseActivity implements View.OnClickListener, AdvertisementView {
        ...
        private void findid() {
            ...
            mBtClick = (Button) findViewById(btn_openSetting);
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                case R.id.mBanner:
                    BaiduTtsUtil.getInstance().speak("请选择商品");
                ...
                case R.id.mTvquery:
                    ...
                    break;
                case R.id.mTvGz:
                    BaiduTtsUtil.getInstance().speak("查询机器故障");
    ...
    //                startactivity(intent, MachineStoppageActivity.class);
                ...
                case R.id.btn_openSetting:
                    BaiduTtsUtil.getInstance().speak("进入调试模式");
                    Toast.makeText(AdvertisementActivity.this, "tts", Toast.LENGTH_SHORT).show();
