...
public class MiniActivity extends AppCompatActivity implements IOfflineResourceConst {
    ...
    private void initTTs() {
        ...
        if (isMixOrOffline) {
            ...
            if (!isSuccess) {
                ...
                print("离线资源存在并且可读, 目录：" + TEMP_DIR);  //ok
            }
        }
        ...
        com.yican.www.control.InitConfig initConfig = new com.yican.www.control.InitConfig(appId, appKey, secretKey, ttsMode, params, listener);
    ...
    private void speak() {
        ...
        int result = mSpeechSynthesizer.speak(TEXT);//语音合成
        mShowText.setText("");
        print("合成并播放 按钮已经点击");
    ...
    private void initView() {
        Button mSpeak = (Button) this.findViewById(R.id.speak);
        Button mStop = (Button) this.findViewById(R.id.stop);
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            public void onClick(View v) {
                int id = v.getId();
                switch (id) {
                    case R.id.speak:  //合成并播放
                        speak();
                        break;
                    case R.id.stop:   //停止合成引擎
                        stop();
                        break;
                    default:
                        break;
        ...
        //Toast.makeText(MiniActivity.this, "UI部分初始化", Toast.LENGTH_SHORT).show();
        //Toast.makeText(MiniActivity.this, "此功能暂未开通", Toast.LENGTH_SHORT).show();
        //Toast.makeText(MiniActivity.this, "此功能暂已开通", Toast.LENGTH_SHORT).show();
        //Toast.makeText(MiniActivity.this, "语音初始化", Toast.LENGTH_SHORT).show();
        //Toast.makeText(MiniActivity.this, "初始化结束", Toast.LENGTH_SHORT).show();

    }

    private void print(String message) {    //屏幕显示打印
        Log.i(TAG, message);
    ...
    private void checkResult(int result, String method) {
        if (result != 0) {
            print("error code :" + result + " method:" + method); //错误代码
        }
    }
