...
import java.util.*;
import com.yican.www.activity.HomeActivity.AlarmReceiver;
...
public class LongRunningService extends Service {
   ...
   public void onCreate() {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        manager.setRepeating(AlarmManager.ELAPSED_REALTIME_WAKEUP, 10*10000+ SystemClock.elapsedRealtime(), 20*10000, pi);//重复
