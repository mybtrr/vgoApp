    ...
    */
    ...
    public AbViewInfo getView(int position, AbViewInfo convertView, ViewGroup parent){
          ...
          if(convertView == null){
	           ...
	           //初始化布局中的元素
			   holder.itemsIcon = (ImageView) view.findViewById(R.id.list_item_iv_shop_image);
		  ...
		  //设置加载中的View
          mAbImageLoader.setLoadingView(convertView.getView().findViewById(R.id.list_item_pb_loading));
